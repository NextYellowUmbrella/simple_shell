...
/**
 * env_command - fn that runs when the env command is executed
 * @commandarray: array containing the name of the command and its options
 * @env: environment variables
 * Return: honestly, this fn doesn't really need to return anything (my bad)
 */
...
/**
 * cd_command - fn that runs when the cd command is executed
 * @commandarray: array containing the name of the command and its options
 * @env: environment variables
 * Return: honestly, this fn doesn't really need to return anything (my bad)
 */
